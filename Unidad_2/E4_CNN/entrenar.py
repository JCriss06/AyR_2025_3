...
data_entrenamiento = "../E4_CNN/F1-Entrenamiento"
data_validacion = "../E4_CNN/F2-Validacion"
...
pasos_validacion = 15 # 50imagenes /batch => max pasos validacion
...
##capa 1
cnn.add(Convolution2D(tot_kernels1, kernel1, padding='same', input_shape=(alto, largo, 1), activation='relu')) #extrae caracteristicas de la imagen
##capa 2
cnn.add(MaxPooling2D(pool_size=stride)) #reduce la dimension de la imagen
##capa 3
...
#version moderna
cnn.save(dir + 'modelo_v2.keras') #estructura                          #'modelo.keras'
cnn.save_weights(dir + 'pesos_v2.weights.h5') #pesos en las capas      #'pesos.weights.h5'
